...
- ***Oct 24, 2021*** The videos of invited talks, panel discussion, and accepted papers are available [here](#program).  
...
|-------|-------| ---------------|
| 08:00 |	08:05 |	Opening remarks [(**Video**)](https://youtu.be/NknkTL600JU){: target="_blank" .text-blue-200} |
| 08:05 |	08:40 |	Invited Speaker # 1 -  ***Rachel Rudinger*** <br> ***When Pigs Fly and Birds Don’t: <br> Exploring Defeasible Inference in Natural Language***{: .text-red-100} [(**Video**)](https://youtu.be/HfQ8GLuSATI){: target="_blank" .text-blue-200} |
| 08:40 |	09:00 |	2-minute lightning talks <br> Paper ids: [2, 3, 4, 6, 7, 8, 14, 15, 17] (videos are linked [below](#accepted-papers)) |
| 09:00 |	09:35 |	Invited Speaker # 2 - ***Maarten Sap***  <br> ***Positive AI with Social Commonsense Models***{: .text-red-100} [(**Video**)](https://youtu.be/g7ZOf7Xa0gk){: target="_blank" .text-blue-200}|
| 09:35 |	10:05 |	Break |
| 10:05 |	10:40 |	Invited Speaker # 3 - ***Sara Hooker***  <br> ***What can compression tell us about generalization?***{: .text-red-100} [(**Video**)](https://youtu.be/LFTVZvEBFSM){: target="_blank" .text-blue-200} |
| 10:40 |	11:00 |	2-minute lightning talks  <br> Paper ids: [1, 5, 9, 10, 11, 12, 13, 16, 18] (videos are linked [below](#accepted-papers))|
| 11:00 |	11:55 |	Panel Discussion [(**Video**)](https://youtu.be/A5hdoayF_N8){: target="_blank" .text-blue-200} |
| 11:55 |	12:20 |	Break |
| 12:20 |	12:55 |	Invited Speaker # 4 - ***Xiang Ren*** <br> ***Commonsense Reasoning in the Wild***{: .text-red-100} [(**Video**)](https://youtu.be/61VAC05bzww){: target="_blank" .text-blue-200} |
| 12:55 |	13:00 | Closing Statements [(**Video**)](https://youtu.be/26WpTTR3eUU){: target="_blank" .text-blue-200} |
...
<li class="note " data-id="9_oCNR6R9l2" data-number="7">
        <span class=".no_toc">   [7]       <a class="paper_title" href="https://openreview.net/forum?id=9_oCNR6R9l2">Artefact Retrieval: Overview of NLP Models with Knowledge Base Access</a> <a target="_blank" style="color: blue" href="videos/7.mp4">(video)</a></span>
...
<li class="note " data-id="MvFv92fUFof" data-number="3">
        <span class=".no_toc">   [3]       <a class="paper_title" href="https://openreview.net/forum?id=MvFv92fUFof">Retrieve, Caption, Generate: Visual Grounding for Enhancing Commonsense in Text Generation Models</a> <a target="_blank" style="color: blue" href="videos/3.mp4">(video)</a></span>
        <div class="note-authors">
 ...
 <li class="note " data-id="WnIpeFJgSZy" data-number="18">
        <span class=".no_toc">    [18]      <a class="paper_title" href="https://openreview.net/forum?id=WnIpeFJgSZy">Story Generation with Commonsense Knowledge Graphs and Axioms</a> <a target="_blank" style="color: blue" href="videos/18.mp4">(video)</a></span>
        <div class="note-authors">
...
<li class="note " data-id="fn5K7VfI3MV" data-number="17">
        <span class=".no_toc">    [17]      <a class="paper_title" href="https://openreview.net/forum?id=fn5K7VfI3MV">No Need to Know Everything! Efficiently Augmenting Language Models With External Knowledge</a> <a target="_blank" style="color: blue" href="videos/17.mp4">(video)</a></span>
        <div class="note-authors">
...
<li class="note " data-id="BigczdxQlGm" data-number="15">
        <span class=".no_toc">     [15]     <a class="paper_title" href="https://openreview.net/forum?id=BigczdxQlGm">COPA-SSE: Semi-Structured Explanations for Commonsense Reasoning</a> <a target="_blank" style="color: blue" href="videos/15.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="1yieqYLUIXj" data-number="14">
        <span class=".no_toc">     [14]     <a class="paper_title" href="https://openreview.net/forum?id=1yieqYLUIXj">CoSe-Co: Sentence Conditioned Generative CommonSense Contextualizer for Language Models</a> <a target="_blank" style="color: blue" href="videos/14.mp4">(video)</a></span>
        <div class="note-authors">
...
<ul>    
    <li class="note " data-id="8oKPQD2KZnA" data-number="1">
        <span class=".no_toc">    [1]      <a class="paper_title" href="https://openreview.net/forum?id=8oKPQD2KZnA">TellMeWhy: A Dataset for Answering Why-Questions in Narratives</a> <a target="_blank" style="color: blue" href="videos/1.mp4">(video)</a></span>
        <div class="note-authors">
     ...
     <li class="note " data-id="vtZzRb1471-" data-number="2">
        <span class=".no_toc">    [2]   <a class="paper_title" href="https://openreview.net/forum?id=vtZzRb1471-">
              Perhaps PTLMs should go to School – A Task to Assess Open Book and Closed Book QA </a> <a target="_blank" style="color: blue" href="videos/2.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="jsuynAVoMzn" data-number="5">
        <span class=".no_toc">      [5]    <a class="paper_title" href="https://openreview.net/forum?id=jsuynAVoMzn">Modeling Worlds in Text</a> <a target="_blank" style="color: blue" href="videos/5.mp4">(video)</a></span>        
        <div class="note-authors">
    ...
    <li class="note " data-id="iAIP15cNLIP" data-number="16">
        <span class=".no_toc">       [16]   <a class="paper_title" href="https://openreview.net/forum?id=iAIP15cNLIP">Like hiking? You probably enjoy nature: Persona-grounded Dialog with Commonsense Expansions</a> <a target="_blank" style="color: blue" href="videos/16.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="Xh1D4dNuEp5" data-number="13">
        <span class=".no_toc">       [13]   <a class="paper_title" href="https://openreview.net/forum?id=Xh1D4dNuEp5">Do Language Models Perform Generalizable Commonsense Inference?</a> <a target="_blank" style="color: blue" href="videos/13.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="FH_yS0ldm-E" data-number="12">
        <span class=".no_toc">       [12]   <a class="paper_title" href="https://openreview.net/forum?id=FH_yS0ldm-E">Retrieval Enhanced Model for Commonsense Generation</a> <a target="_blank" style="color: blue" href="videos/12.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="KFcjxSNdMBq" data-number="11">
        <span class=".no_toc">    [11]      <a class="paper_title" href="https://openreview.net/forum?id=KFcjxSNdMBq">Prompting Contrastive Explanations for Commonsense Reasoning Tasks</a> <a target="_blank" style="color: blue" href="videos/11.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="pFRIXhSiJpq" data-number="10">
        <span class=".no_toc">      [10]    <a class="paper_title" href="https://openreview.net/forum?id=pFRIXhSiJpq">COM2SENSE: A Commonsense Reasoning Benchmark with Complementary Sentences</a> <a target="_blank" style="color: blue" href="videos/10.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="jnIiy6AGUmo" data-number="9">
        <span class=".no_toc">    [9]      <a class="paper_title" href="https://openreview.net/forum?id=jnIiy6AGUmo">Fusing Context Into Knowledge Graph for Commonsense Question Answering</a> <a target="_blank" style="color: blue" href="videos/9.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="8REVPGZVsP" data-number="8">
        <span class=".no_toc">    [8]      <a class="paper_title" href="https://openreview.net/forum?id=8REVPGZVsP">Explanations for CommonsenseQA: New Dataset and Models</a> <a target="_blank" style="color: blue" href="videos/8.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="T9FwSfwA2Li" data-number="6">
        <span class=".no_toc">   [6]       <a class="paper_title" href="https://openreview.net/forum?id=T9FwSfwA2Li">On Commonsense Cues in BERT for Solving Commonsense Tasks</a> <a target="_blank" style="color: blue" href="videos/6.mp4">(video)</a></span>
        <div class="note-authors">
    ...
    <li class="note " data-id="wOhNz5kDWZ" data-number="4">
        <span class=".no_toc">     [4]     <a class="paper_title" href="https://openreview.net/forum?id=wOhNz5kDWZ">Could you give me a hint? Generating inference graphs for defeasible reasoning</a> <a target="_blank" style="color: blue" href="videos/4.mp4">(video)</a></span>
        <div class="note-authors">
